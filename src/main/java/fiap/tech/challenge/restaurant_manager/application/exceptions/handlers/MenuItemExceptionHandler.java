...
public class MenuItemExceptionHandler {
    ...
    public ResponseEntity<ApiErrorArray> handleBadRequestExceptions(CardapioException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiErrorArray> handleNotFoundExceptions(InvalidMenuItemException ex, HttpServletRequest request) {

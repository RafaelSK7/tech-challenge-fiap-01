...
public class MenuItemResource {
    ...
    public MenuItemResource(MenuItemController menuItemController) {
    ...
    public ResponseEntity<MenuItemResponse> createMenuItem(@RequestBody @Valid CreateMenuItemRequest menuItemRequest,
        ...
        MenuItemResponse createdMenuItem = menuItemController.createMenuItem(menuItemRequest);
    ...
    public Page<MenuItemResponse> findAll(
        ...
        return menuItemController.findAll(pageable);
    }

    @GetMapping("/{id}")
    public ResponseEntity<MenuItemResponse> findById(@PathVariable Long id) {
        log.info("Buscando o cardapio.");
        MenuItemResponse response = menuItemController.findById(id);
    ...
    public ResponseEntity<MenuItemResponse> updateMenuItem(@PathVariable Long id,
        ...
        MenuItemResponse menuItem = menuItemController.updateMenuItem(id, menuItemRequest);
